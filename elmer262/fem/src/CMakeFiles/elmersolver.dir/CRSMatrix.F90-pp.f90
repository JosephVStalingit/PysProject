# 1 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/CRSMatrix.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/CRSMatrix.F90"
!
...
!
!
# 36 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/CRSMatrix.F90"
...
# 38 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/CRSMatrix.F90" 2

# 1 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/build/fem/config.h" 1
# 39 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/CRSMatrix.F90" 2
...
!------------------------------------------------------------------------------
    INTEGER :: i, j
# 119 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/CRSMatrix.F90"
    A % Values = 0.0d0
...
# 1477 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/CRSMatrix.F90"
...
# 1503 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/CRSMatrix.F90"
    A % Cols = 0
    A % Diag = 0
...
# 1541 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/CRSMatrix.F90"
...
!------------------------------------------------------------------------------
    INTEGER, POINTER   :: Cols(:),Rows(:)
    REAL(KIND=dp), POINTER   :: Values(:), Abs_Values(:)
...
!------------------------------------------------------------------------------
     ...
     INTEGER :: i,j,k,n,m
     REAL(KIND=dp) :: rsum
# 1920 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/CRSMatrix.F90"
!------------------------------------------------------------------------------
...
!------------------------------------------------------------------------------
    INTEGER, POINTER   :: ColsA(:),RowsA(:),ColsB(:),RowsB(:),&
        Rows(:),Cols(:),invPermA(:),invPermB(:),invPermC(:),Perm(:)
    REAL(KIND=dp), POINTER   :: ValuesA(:),ValuesB(:),Values(:),rhs(:)
...
!------------------------------------------------------------------------------
    ...
    REAL(KIND=dp), DIMENSION(ipar(3)), INTENT(IN) :: v   !< Right-hand-side vector
    REAL(KIND=dp), DIMENSION(ipar(3)), INTENT(OUT) :: u   !< Solution vector
    ...
    END DO
    !$OMP END PARALLEL DO
    CALL CRS_LUSolve( ipar(3),GlobalMatrix,u )
...
!------------------------------------------------------------------------------
    INTEGER, DIMENSION(*), INTENT(IN) :: ipar  !< structure holding info from (HUTIter-iterative solver package)
    COMPLEX(KIND=dp), DIMENSION(ipar(3)), INTENT(IN) :: v !< Right-hand-side vector
    COMPLEX(KIND=dp), DIMENSION(ipar(3)), INTENT(OUT) :: u !< Solution vector

    u = v
    CALL CRS_ComplexLUSolve( ipar(3),GlobalMatrix,u )
...
# 4812 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/CRSMatrix.F90"
...
!------------------------------------------------------------------------------
    ...
    INTEGER, DIMENSION(*), INTENT(IN) :: ipar      !< Structure holding info HUTIter-iterative solver package
    COMPLEX(KIND=dp), INTENT(IN) :: u(ipar(3))      !< vector to multiply u
    COMPLEX(KIND=dp) :: v(ipar(3))  !< result vector
