# 1 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/IterativeMethods.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/IterativeMethods.F90"
!
...
!
!
# 36 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/IterativeMethods.F90"
...
# 48 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/IterativeMethods.F90" 2

! if using old huti_fdefs.h, later obsolete
# 71 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/IterativeMethods.F90"
...
!------------------------------------------------------------------------------
  SUBROUTINE itermethod_sgs( xvec, rhsvec, &
    ...
    REAL(KIND=dp), DIMENSION(ipar(3)) :: xvec, rhsvec
    DOUBLE PRECISION, DIMENSION(10) :: dpar
    REAL(KIND=dp), DIMENSION(ipar(4),ipar(3)) :: work
    ...
    MinTol = dpar(1)
    MaxTol = dpar(2)
    OutputInterval = ipar(5) 
    Omega = dpar(3)

    CALL sgs(ndim, GlobalMatrix, xvec, rhsvec, Rounds, MinTol, MaxTol, Residual, &
        Converged, Diverged, OutputInterval, Omega)

    IF(Converged) ipar(30) = 1
    IF(Diverged) ipar(30) = 3
    IF ( (.NOT. Converged) .AND. (.NOT. Diverged) ) ipar(30) = 2
...
!------------------------------------------------------------------------------
 SUBROUTINE itermethod_jacobi( xvec, rhsvec, &
    ...
    INTEGER, DIMENSION(50) :: ipar
    REAL(KIND=dp), TARGET, DIMENSION(ipar(3)) :: xvec, rhsvec
    DOUBLE PRECISION, DIMENSION(10) :: dpar
    REAL(KIND=dp), DIMENSION(ipar(4),ipar(3)) :: work
...
!-----------------------------------------------------------------------------------
      ndim = ipar(3)
      IF(Constrained) ipar(3) = ndim+nc
      CALL pcondrsubr(u,v,ipar)
      IF(Constrained) ipar(3) = ndim
!-----------------------------------------------------------------------------------
...
!------------------------------------------------------------------------------
  SUBROUTINE itermethod_bicgstabl( xvec, rhsvec, &
    ...
    INTEGER, DIMENSION(50) :: ipar
    REAL(KIND=dp), TARGET, DIMENSION(ipar(3)) :: xvec, rhsvec
    ! DOUBLE PRECISION, DIMENSION(ipar(3)), TARGET :: xvec, rhsvec
    DOUBLE PRECISION, DIMENSION(10) :: dpar
    REAL(KIND=dp), DIMENSION(ipar(4),ipar(3)) :: work
    ...
    MaxTol = dpar(2)
    OutputInterval = ipar(5) 
    PolynomialDegree = ipar(16) 
    UseStopCFun = ipar(12) == 10

    PseudoComplex = ( ipar(7) > 0 )  
...
# 1667 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/IterativeMethods.F90"
...
!------------------------------------------------------------------------------
    ...
    INTEGER, DIMENSION(50) :: ipar
    COMPLEX(KIND=dp), TARGET, DIMENSION(ipar(3)) :: xvec, rhsvec
    DOUBLE PRECISION, DIMENSION(10) :: dpar
    COMPLEX(KIND=dp), DIMENSION(ipar(4),ipar(3)) :: work

    COMPLEX(KIND=dp) :: y(ipar(3)),f(ipar(3))
