# 1 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/LinearForms.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/LinearForms.F90"
!
...
!
!
# 35 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/LinearForms.F90"
...
# 45 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/LinearForms.F90" 2
...
!DIR$ UNROLL
  ...
  SUBROUTINE LinearForms_GradUdotU(m, n, dim, GradU, U, weight, G, alpha, beta)
    ...
    INTEGER, INTENT(IN) :: m, n, dim
    REAL(KIND=dp) , INTENT(IN) :: GradU(:,:,:), U(:,:), weight(:)
    REAL(KIND=dp) , INTENT(INOUT) :: G(:,:)
...
!DIR$ UNROLL
  ...
  SUBROUTINE LinearForms_UdotV(m, n, dim, U, V, weight, G, alpha)
    ...
    INTEGER, INTENT(IN) :: m, n, dim
    REAL(KIND=dp) , INTENT(IN) :: U(:,:), V(:,:), weight(:)
    REAL(KIND=dp) , INTENT(INOUT) :: G(:,:)
    REAL(KIND=dp) , INTENT(IN), OPTIONAL :: alpha(:)
...
!DIR$ ATTRIBUTES ALIGN:64::wrk
  ...
  SUBROUTINE LinearForms_UdotU(m, n, dim, U, weight, G, alpha)
    ...
    INTEGER, INTENT(IN) :: m, n, dim
    REAL(KIND=dp) , INTENT(IN) :: U(:,:), weight(:)
    REAL(KIND=dp) , INTENT(INOUT) :: G(:,:)
    REAL(KIND=dp) , INTENT(IN), OPTIONAL :: alpha(:)
