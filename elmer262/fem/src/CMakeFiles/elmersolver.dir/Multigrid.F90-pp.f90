# 1 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/Multigrid.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/Multigrid.F90"
!
...
!
!
# 36 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/Multigrid.F90"
...
!------------------------------------------------------------------------------
       ...
       REAL(KIND=dp), TARGET  :: ForceVector(:), Solution(:)
!------------------------------------------------------------------------------
...
!------------------------------------------------------------------------------
       ...
       REAL(KIND=dp) :: ResidualNorm, RHSNorm, Tolerance, ILUTOL, tmp
       REAL(KIND=dp), POINTER  :: Residual(:), Residual2(:), Solution2(:), &
               SaveVals(:), Basis(:)
...
!------------------------------------------------------------------------------
    ...
    REAL(KIND=dp), POINTER  :: Residual2(:)
