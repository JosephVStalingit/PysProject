# 1 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/SolverUtils.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/SolverUtils.F90"
!
...
!
!
# 40 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/SolverUtils.F90"
...
# 51 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/SolverUtils.F90" 2
...
!------------------------------------------------------------------------------
     ...
     IF ( Solver % Matrix % Lumped ) THEN
       ...
       DO i=1,n
         ...
         END DO
       END DO
# 410 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/SolverUtils.F90"
     END IF
!------------------------------------------------------------------------------
...
!------------------------------------------------------------------------------
       ...
       DO i=1,n
         ...
         END DO
       END DO
# 658 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/SolverUtils.F90"
!------------------------------------------------------------------------------
     END IF
!------------------------------------------------------------------------------
...
!------------------------------------------------------------------------------
    ...
    DO k=1,A % NumberOfRows
      ...
      IF ( A % ConstrainedDOF(k) ) THEN
        ...
        IF(.NOT. NoDiag ) THEN
# 9079 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/SolverUtils.F90"
...
# 15513 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/SolverUtils.F90"
        END IF
...
# 15800 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/SolverUtils.F90"
...
# 16040 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/SolverUtils.F90"
    CALL Fatal('AMGXSolver', "AMGX doesn't seem to be included.")
...
# 16496 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/SolverUtils.F90"
...
!------------------------------------------------------------------------------
    REAL(KIND=dp) , TARGET :: b(:)   !< The RHS vector
...
!------------------------------------------------------------------------------
  ...
  REAL(KIND=dp), POINTER  :: CollectionVector(:), RestVector(:), AddVector(:) 
...
!----------------------------------------------------------------------------------    
  ...
  SUBROUTINE FCT_Correction( Solver  )
    ...
    REAL(KIND=dp), POINTER  :: M_C(:), SaveValues(:)
    ...
    ! Compute: ku = K*ulow
# 24054 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/SolverUtils.F90"
