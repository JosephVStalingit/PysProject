# 1 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/modules/CahnHilliard.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/modules/CahnHilliard.F90"
!
...
! *****************************************************************************/
!
# 35 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/modules/CahnHilliard.F90"

!-----------------------------------------------------------------------------
!>  Solve the Cahn-Hilliard interface equations as a strongly coupled system.
!-----------------------------------------------------------------------------
SUBROUTINE CahnHilliardSolver( Model,Solver,dt,Transient)
!------------------------------------------------------------------------------
  USE DefUtils
...
!------------------------------------------------------------------------------
  ...
  DO iter=1,NonlinIter
    ...
    CALL Info( 'Cahn-Hilliard interface Solver', Message, Level=4 )
...
!------------------------------------------------------------------------------
END SUBROUTINE CahnHilliardSolver
!------------------------------------------------------------------------------
