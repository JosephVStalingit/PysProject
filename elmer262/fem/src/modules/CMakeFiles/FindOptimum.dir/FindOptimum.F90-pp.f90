# 1 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/modules/FindOptimum.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/modules/FindOptimum.F90"
!
...
! *****************************************************************************/
!
# 35 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/modules/FindOptimum.F90"
...
!------------------------------------------------------------------------------
  ...
  IF( OptimizationsDone == 0) THEN
    ...
    CALL Info('FindOptimum','The reason for the change is that it became very cumbersome to',Level=3)
    CALL Info('FindOptimum','further develop the functionality on the same level as other',Level=3)
