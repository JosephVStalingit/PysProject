# 1 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/modules/FreeSurfaceSolver.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/modules/FreeSurfaceSolver.F90"
!
...
! *****************************************************************************/
!
# 36 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/modules/FreeSurfaceSolver.F90"
...
SUBROUTINE FreeSurfaceSolver( Model,Solver,dt,TransientSimulation )
  ...
  ! ( we should actually even not be here...)
  !------------------------------------------------------------------------------
  ...
  WRITE(Message,'(A,I0)') 'Size of problem: ',SIZE(Solver % Variable % Values)
  CALL Info( SolverName, Message, Level=8 )
