# 1 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/modules/HelmholtzBEM.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/modules/HelmholtzBEM.F90"
!
...
!------------------------------------------------------------------------------
     ...
     COMPLEX(KIND=dp), POINTER  :: Potential(:),ForceVector(:), Diagonal(:)
...
# 1 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fhutiter/include/huti_fdefs.h" 1
...
# 96 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fhutiter/include/huti_fdefs.h"
...
# 126 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fhutiter/include/huti_fdefs.h"
...
# 712 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/modules/HelmholtzBEM.F90" 2
!------------------------------------------------------------------------------
...
!------------------------------------------------------------------------------
       ...
       dpar(1) = ListGetConstReal( Solver % Values, &
            'Linear System Convergence Tolerance' )

       dpar(2) = ListGetConstReal( Solver % Values, &
            'Linear System Divergence Limit', GotIt )
       IF(.NOT. GotIt) dpar(2) = 1.0d20       
       
       ipar(10) = ListGetInteger( Solver % Values, &
            'Linear System Max Iterations' )

       ipar(5)  = ListGetInteger( SolverParam % Values, &
...
!------------------------------------------------------------------------------
      ...
      INTEGER :: ipar(*)
!------------------------------------------------------------------------------
      v(1:ipar(3)) = MATMUL( Matrix, u(1:ipar(3)) )
