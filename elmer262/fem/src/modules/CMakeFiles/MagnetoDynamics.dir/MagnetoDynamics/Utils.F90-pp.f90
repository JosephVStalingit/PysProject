# 1 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/modules/MagnetoDynamics/Utils.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/modules/MagnetoDynamics/Utils.F90"
!
...
! *****************************************************************************/
!
# 35 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/modules/MagnetoDynamics/Utils.F90"
...
!-------------------------------------------------------------------------------
  ...
  SUBROUTINE PackEdgeRows(CM, Model, ColOffset)
    ...
    INTEGER :: ColOffsetF
    REAL(KIND=dp), POINTER  :: V(:), RHS(:)
    INTEGER, POINTER  :: R(:), C(:), InvPerm(:), Perm(:)
