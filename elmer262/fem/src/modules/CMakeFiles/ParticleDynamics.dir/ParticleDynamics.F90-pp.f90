# 1 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/modules/ParticleDynamics.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/src/modules/ParticleDynamics.F90"
!
...
CONTAINS   
  ...
  ! Compute field values at the given points in the FE mesh. 
   ...
   SUBROUTINE ParticleFieldInteraction(Particles,dtime,SetParticles,SetFields ) 
     ...
     TYPE(VarPointer_t) :: ActiveVars(20), ParticleVars(20)
     ...
     LOGICAL :: GotGravity, GotBuoyancy, GotField, &
         ...
         NormalizedVars(20)
     INTEGER :: ActiveOpers(20),ActiveGroups(20)
