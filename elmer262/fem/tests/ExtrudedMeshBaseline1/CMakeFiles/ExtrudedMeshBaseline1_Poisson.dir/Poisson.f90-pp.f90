# 1 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/tests/ExtrudedMeshBaseline1/Poisson.f90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/tests/ExtrudedMeshBaseline1/Poisson.f90"
...
!------------------------------------------------------------------------------
  ...
  TYPE(Mesh_t), POINTER :: Mesh,mesh1,newmesh
...
!call meshextrude(mesh,mesh1,newmesh)
