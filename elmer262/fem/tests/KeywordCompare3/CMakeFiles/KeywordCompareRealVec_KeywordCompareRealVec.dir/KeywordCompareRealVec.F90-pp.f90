# 1 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/tests/KeywordCompare3/KeywordCompareRealVec.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/tests/KeywordCompare3/KeywordCompareRealVec.F90"
!------------------------------------------------------------------------------
...
!------------------------------------------------------------------------------
  ...
  DO key = 1, 10
    ...
    PRINT *,'Speed-up for RealVec:',OldTimes(key)/NewTimes(key)
  END DO
