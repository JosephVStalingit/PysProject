# 1 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/tests/ModelPDEthreaded/ModelPDEthreaded.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/tests/ModelPDEthreaded/ModelPDEthreaded.F90"
!-----------------------------------------------------------------------------
...
!------------------------------------------------------------------------------
    ...
    REAL(KIND=dp), POINTER  :: diff_coeff(:), conv_coeff(:), react_coeff(:), &
...
!------------------------------------------------------------------------------
    ...
    Velo = 0._dp
    CALL GetRealValues(Material, 'convection velocity 1', Velo(1:n,1),Found, UElement=Element)
    CALL GetRealValues(Material, 'convection velocity 2', Velo(1:n,2),Found, UElement=Element)
    ...
    CALL LinearForms_GradUdotGradU(ngp, nd, Element % TYPE % DIMENSION, dBasisdx, DetJ, STIFF, DiffInBasis)
    ! reaction term 
    ! STIFF=STIFF+(R*u,v)
