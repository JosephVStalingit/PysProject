# 1 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/tests/P2ndDerivatives/P2ndDerivativesTest.f90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fem/tests/P2ndDerivatives/P2ndDerivativesTest.f90"
...
!------------------------------------------------------------------------------
    ...
    ALLOCATE(dNodal(nd,nd,3), dx(nd,nd,3))
    ALLOCATE(STIFF(nd,nd), FORCE(nd))
    STIFF = 0.0d0
    FORCE = 0.0d0
