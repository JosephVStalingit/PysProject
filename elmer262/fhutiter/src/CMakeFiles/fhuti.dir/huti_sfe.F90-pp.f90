# 1 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fhutiter/src/huti_sfe.F90"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fhutiter/src/huti_sfe.F90"
!
...
# 26 "C:/Users/JosephVStalin/Desktop/PysProject/elmerfem-release-26.2.1/fhutiter/src/huti_sfe.F90" 2
...
CONTAINS
  ...
  SUBROUTINE huti_s_cg(xvec, rhsvec, ipar, dpar, work, matvecsubr, &
    ...
    REAL, DIMENSION(ipar(3)) :: xvec, rhsvec
    ...
    CALL huti_scgsolv(ipar(3), ipar(4), xvec, rhsvec, ipar, dpar, &
  ...
  SUBROUTINE huti_s_tfqmr(xvec, rhsvec, ipar, dpar, work, matvecsubr, &
    ...
    CALL huti_stfqmrsolv(ipar(3), ipar(4), xvec, rhsvec, ipar, dpar, &
         & work, matvecsubr, pcondlsubr, pcondrsubr, dotprodfun, &
         & normfun, mstopfun)
  ...
  SUBROUTINE huti_s_cgs(xvec, rhsvec, ipar, dpar, work, matvecsubr, &
    ...
    CALL huti_scgssolv(ipar(3), ipar(4), xvec, rhsvec, ipar, dpar, &
         & work, matvecsubr, pcondlsubr, pcondrsubr, dotprodfun, &
         & normfun, mstopfun)
  ...
  SUBROUTINE huti_s_qmr(xvec, rhsvec, ipar, dpar, work, matvecsubr, &
    ...
    CALL huti_sqmrsolv(ipar(3), ipar(4), xvec, rhsvec, ipar, dpar, &
         & work, matvecsubr, pcondlsubr, pcondrsubr, dotprodfun, &
         & normfun, mstopfun)
  ...
  SUBROUTINE huti_s_bicgstab(xvec, rhsvec, ipar, dpar, work, matvecsubr, &
    ...
    CALL huti_sbicgstabsolv(ipar(3), ipar(4), xvec, rhsvec, ipar, dpar, &
         & work, matvecsubr, pcondlsubr, pcondrsubr, dotprodfun, &
         & normfun, mstopfun)
  ...
  SUBROUTINE huti_s_gmres(xvec, rhsvec, ipar, dpar, work, matvecsubr, &
    ...
    CALL huti_sgmressolv(ipar(3), ipar(4), xvec, rhsvec, ipar, dpar, &
         & work, matvecsubr, pcondlsubr, pcondrsubr, dotprodfun, &
         & normfun, mstopfun)
  ...
  SUBROUTINE huti_s_bicgstab_2(xvec, rhsvec, ipar, dpar, work, matvecsubr, &
    ...
    CALL huti_sbicgstab_2solv(ipar(3), ipar(4), xvec, rhsvec, ipar, &
  ...
  SUBROUTINE huti_d_cg(xvec, rhsvec, ipar, dpar, work, matvecsubr, &
    ...
    INTEGER, DIMENSION(50) :: ipar
    DOUBLE PRECISION, DIMENSION(ipar(3)) :: xvec, rhsvec
    DOUBLE PRECISION, DIMENSION(10) :: dpar
    ...
    CALL huti_dcgsolv(ipar(3), ipar(4), xvec, rhsvec, ipar, dpar, &
         & work, matvecsubr, pcondlsubr, pcondrsubr, dotprodfun, &
         & normfun, mstopfun)
  ...
  SUBROUTINE huti_d_cgs(xvec, rhsvec, ipar, dpar, work, matvecsubr, &
    ...
    CALL huti_dcgssolv(ipar(3), ipar(4), xvec, rhsvec, ipar, dpar, &
         & work, matvecsubr, pcondlsubr, pcondrsubr, dotprodfun, &
         & normfun, mstopfun)
  ...
  SUBROUTINE huti_d_bicgstab(xvec, rhsvec, ipar, dpar, work, matvecsubr, &
    ...
    CALL huti_dbicgstabsolv(ipar(3), ipar(4), xvec, rhsvec, ipar, dpar, &
         & work, matvecsubr, pcondlsubr, pcondrsubr, dotprodfun, &
         & normfun, mstopfun)
  ...
  SUBROUTINE huti_d_tfqmr(xvec, rhsvec, ipar, dpar, work, matvecsubr, &
    ...
    CALL huti_dtfqmrsolv(ipar(3), ipar(4), xvec, rhsvec, ipar, dpar, &
         & work, matvecsubr, pcondlsubr, pcondrsubr, dotprodfun, &
         & normfun, mstopfun)
  ...
  SUBROUTINE huti_d_qmr(xvec, rhsvec, ipar, dpar, work, matvecsubr, &
    ...
    CALL huti_dqmrsolv(ipar(3), ipar(4), xvec, rhsvec, ipar, dpar, &
         & work, matvecsubr, pcondlsubr, pcondrsubr, dotprodfun, &
         & normfun, mstopfun)
  ...
  SUBROUTINE huti_d_gmres(xvec, rhsvec, ipar, dpar, work, matvecsubr, &
    ...
    CALL huti_dgmressolv(ipar(3), ipar(4), xvec, rhsvec, ipar, dpar, &
         & work, matvecsubr, pcondlsubr, pcondrsubr, dotprodfun, &
         & normfun, mstopfun)
  ...
  SUBROUTINE huti_d_bicgstab_2(xvec, rhsvec, ipar, dpar, work, matvecsubr, &
    ...
    CALL huti_dbicgstab_2solv(ipar(3), ipar(4), xvec, rhsvec, ipar, &
         & dpar, work, matvecsubr, pcondlsubr, pcondrsubr, dotprodfun, &
         & normfun, mstopfun)
  ...
  SUBROUTINE huti_c_cg(xvec, rhsvec, ipar, dpar, work, matvecsubr, &
    ...
    INTEGER, DIMENSION(50) :: ipar
    COMPLEX, DIMENSION(ipar(3)) :: xvec, rhsvec
    DOUBLE PRECISION, DIMENSION(10) :: dpar
    ...
    CALL huti_ccgsolv(ipar(3), ipar(4), xvec, rhsvec, ipar, dpar, &
         & work, matvecsubr, pcondlsubr, pcondrsubr, dotprodfun, &
         & normfun, mstopfun)
  ...
  SUBROUTINE huti_c_bicgstab(xvec, rhsvec, ipar, dpar, work, matvecsubr, &
    ...
    CALL huti_cbicgstabsolv(ipar(3), ipar(4), xvec, rhsvec, ipar, dpar, &
         & work, matvecsubr, pcondlsubr, pcondrsubr, dotprodfun, &
         & normfun, mstopfun)
  ...
  SUBROUTINE huti_c_qmr(xvec, rhsvec, ipar, dpar, work, matvecsubr, &
    ...
    CALL huti_cqmrsolv(ipar(3), ipar(4), xvec, rhsvec, ipar, dpar, &
         & work, matvecsubr, pcondlsubr, pcondrsubr, dotprodfun, &
         & normfun, mstopfun)
  ...
  SUBROUTINE huti_c_tfqmr(xvec, rhsvec, ipar, dpar, work, matvecsubr, &
    ...
    CALL huti_ctfqmrsolv(ipar(3), ipar(4), xvec, rhsvec, ipar, dpar, &
         & work, matvecsubr, pcondlsubr, pcondrsubr, dotprodfun, &
         & normfun, mstopfun)
  ...
  SUBROUTINE huti_c_gmres(xvec, rhsvec, ipar, dpar, work, matvecsubr, &
    ...
    CALL huti_cgmressolv(ipar(3), ipar(4), xvec, rhsvec, ipar, dpar, &
         & work, matvecsubr, pcondlsubr, pcondrsubr, dotprodfun, &
         & normfun, mstopfun)
  ...
  SUBROUTINE huti_c_bicgstab_2(xvec, rhsvec, ipar, dpar, work, matvecsubr, &
    ...
    CALL huti_cbicgstab_2solv(ipar(3), ipar(4), xvec, rhsvec, ipar, &
         & dpar, work, matvecsubr, pcondlsubr, pcondrsubr, dotprodfun, &
         & normfun, mstopfun)
  ...
  SUBROUTINE huti_z_cg(xvec, rhsvec, ipar, dpar, work, matvecsubr, &
    ...
    INTEGER :: ndim, wrkdim
    INTEGER, DIMENSION(50) :: ipar
    DOUBLE COMPLEX, DIMENSION(ipar(3)) :: xvec, rhsvec
    DOUBLE PRECISION, DIMENSION(10) :: dpar
    ...
    CALL huti_zcgsolv(ipar(3), ipar(4), xvec, rhsvec, ipar, dpar, &
         & work, matvecsubr, pcondlsubr, pcondrsubr, dotprodfun, &
         & normfun, mstopfun)
  ...
  SUBROUTINE huti_z_cgs(xvec, rhsvec, ipar, dpar, work, matvecsubr, &
    ...
    CALL huti_zcgssolv(ipar(3), ipar(4), xvec, rhsvec, ipar, dpar, &
         & work, matvecsubr, pcondlsubr, pcondrsubr, dotprodfun, &
         & normfun, mstopfun)
  ...
  SUBROUTINE huti_z_bicgstab(xvec, rhsvec, ipar, dpar, work, matvecsubr, &
    ...
    CALL huti_zbicgstabsolv(ipar(3), ipar(4), xvec, rhsvec, ipar, dpar, &
         & work, matvecsubr, pcondlsubr, pcondrsubr, dotprodfun, &
         & normfun, mstopfun)
  ...
  SUBROUTINE huti_z_qmr(xvec, rhsvec, ipar, dpar, work, matvecsubr, &
    ...
    CALL huti_zqmrsolv(ipar(3), ipar(4), xvec, rhsvec, ipar, dpar, &
         & work, matvecsubr, pcondlsubr, pcondrsubr, dotprodfun, &
         & normfun, mstopfun)
  ...
  SUBROUTINE huti_z_tfqmr(xvec, rhsvec, ipar, dpar, work, matvecsubr, &
    ...
    CALL huti_ztfqmrsolv(ipar(3), ipar(4), xvec, rhsvec, ipar, dpar, &
         & work, matvecsubr, pcondlsubr, pcondrsubr, dotprodfun, &
         & normfun, mstopfun)
  ...
  SUBROUTINE huti_z_gmres(xvec, rhsvec, ipar, dpar, work, matvecsubr, &
    ...
    CALL huti_zgmressolv(ipar(3), ipar(4), xvec, rhsvec, ipar, dpar, &
         & work, matvecsubr, pcondlsubr, pcondrsubr, dotprodfun, &
         & normfun, mstopfun)
  ...
  SUBROUTINE huti_z_bicgstab_2(xvec, rhsvec, ipar, dpar, work, matvecsubr, &
    ...
    CALL huti_zbicgstab_2solv(ipar(3), ipar(4), xvec, rhsvec, ipar, &
         & dpar, work, matvecsubr, pcondlsubr, pcondrsubr, dotprodfun, &
         & normfun, mstopfun)
